...
const obsStub: Observation = {
  ...
  nodes: [
    { handle: "live-a", role: "textbox", name: "Sample Account Handle", valueDigest: null, selectedIndex: null, editable: true },
    { handle: "live-b", role: "textbox", name: "Sample Passphrase", valueDigest: null, selectedIndex: null, editable: true },
    { handle: "live-c", role: "button", name: "Enter Sample Vault", valueDigest: null, selectedIndex: null, editable: false },
  ],
  screenshot: null,
};
...
describe("recordCassette", () => {
  ...
  it("writes every exchange to disk, redacts secrets before they land, and the written file replays", async () => {
    ...
    const rec1: Observation = {
      ...
      nodes: [{ handle: "o1n0", role: "textbox", name: "Sample SSN Field", valueDigest: "", selectedIndex: null, editable: true }],
      screenshot: null,
    };
    const rec2: Observation = {
      url: "https://example.test/synthetic/confirm",
      title: "Synthetic Confirm",
      nodes: [{ handle: "o2n0", role: "link", name: "Continue", valueDigest: null, selectedIndex: null, editable: false }],
      screenshot: null,
    };
    ...
    const replay1: Observation = {
      url: rec1.url,
      title: rec1.title,
      nodes: [{ handle: "z9", role: "textbox", name: "Sample SSN Field", valueDigest: "0123456789abcdef", selectedIndex: null, editable: true }],
      screenshot: null,
    };
    ...
    const replay2: Observation = {
      url: rec2.url,
      title: rec2.title,
      nodes: [{ handle: "z10", role: "link", name: "Continue", valueDigest: null, selectedIndex: null, editable: false }],
      screenshot: null,
    };
